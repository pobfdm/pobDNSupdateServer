...
var	$DSN =  'sqlite:../db.sqlite' ;    
var	$DBUSER = '';
var $DBPASS = '';
 
//---Location credentials in db
var $DBTABLE   = 'accounts';					// name table containing users
var $FIELDUSER = 'email';					// name field containing the username
...
var $SESSIONUSER='pobdns_auth_user' ;
var $SESSIONPASS='pobdns_auth_pass' ;
var $SESSIONUSERID='pobdns_auth_userid' ;
